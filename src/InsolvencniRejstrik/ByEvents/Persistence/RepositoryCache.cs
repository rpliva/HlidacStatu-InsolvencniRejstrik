...
namespace InsolvencniRejstrik.ByEvents
{
	class RepositoryCache : IRepository
	{
		...
		public Rizeni GetInsolvencyProceeding(string spisovaZnacka, Func<string, Rizeni> createNewInsolvencyProceeding) => RizeniCache.GetOrAdd(spisovaZnacka, UnderlyingRepository.GetInsolvencyProceeding(spisovaZnacka, createNewInsolvencyProceeding) ?? createNewInsolvencyProceeding(spisovaZnacka));
